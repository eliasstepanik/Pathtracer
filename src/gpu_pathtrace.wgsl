...
struct Triangle { v0: vec4<f32>, v1: vec4<f32>, v2: vec4<f32>, normal: vec4<f32>, mesh_index: u32, _pad: vec3<f32> };
struct MeshBound { center_radius: vec4<f32> };
struct MeshMaterial { color: vec4<f32>, metallic: f32, roughness: f32, ior: f32, _pad: f32 };
...
@group(0) @binding(6) var<storage, read> mesh_bounds: array<MeshBound>;
@group(0) @binding(7) var<storage, read> mesh_materials: array<MeshMaterial>;
...
fn hit_bound(ray: Ray, center: vec3<f32>, radius: f32, t_max: f32) -> bool {
