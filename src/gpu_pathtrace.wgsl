...
struct Camera { pos: vec4<f32>, forward: vec4<f32>, up: vec4<f32>, right: vec4<f32>, width: u32, height: u32, fov: f32, sphere_count: u32, plane_count: u32, aperture: f32, focus_dist: f32, _pad: u32 };
